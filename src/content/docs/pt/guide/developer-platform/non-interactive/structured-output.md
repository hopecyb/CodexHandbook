...
Ver [Visão geral do SDK](/pt/guide/developer-platform/sdk-overview/).
...
- [ ] Alinhado com a estratégia de [códigos de saída](/pt/guide/developer-platform/non-interactive/exit-codes-and-retries/)
