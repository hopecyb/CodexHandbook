...
1. [codex exec](/pt/guide/developer-platform/non-interactive/codex-exec/)
2. [Scripts e pipelines](/pt/guide/developer-platform/non-interactive/scripts-and-pipelines/)
3. [Saída estruturada](/pt/guide/developer-platform/non-interactive/structured-output/)
4. [Códigos de saída e retries](/pt/guide/developer-platform/non-interactive/exit-codes-and-retries/)
