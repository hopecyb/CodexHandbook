...
- Ligação a [validar fontes](/pt/guide/quality/validate-sources/)
...
Tarefas de investigação longas devem ser divididas em várias rondas; ver [gestão de tarefas longas](/pt/prompts/long-running-tasks/).
