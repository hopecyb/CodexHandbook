...
4. **敏感内容**：合同、身份证扫描等走 [敏感上下文](/05-core-capabilities/context/sensitive-context/) 流程
...
- diff 不可读时，验收靠**打开文件** + 对照 [验证产物](/05-core-capabilities/quality/verify-artifacts/)
- 生成物列表见 [生成物验收](/05-core-capabilities/files-and-artifacts/generated-artifacts/)
