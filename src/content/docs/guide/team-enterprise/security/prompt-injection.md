...
**Prompt 注入**指攻击者（或恶意内容）通过 issue、网页、依赖注释等渠道，诱导 Agent **忽略策略、泄露数据或执行危险命令**。它是 [威胁模型](/guide/team-enterprise/security/threat-model/) 中的高频项，与 [敏感上下文](/guide/context/sensitive-context/) 和 CI 设计直接相关。
