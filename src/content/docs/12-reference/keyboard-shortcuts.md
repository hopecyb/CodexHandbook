...
- CLI TUI 与 IDE 的差异
- 与 [命令与快捷方式](/04-product-guides/cli/commands-and-shortcuts/) 的分工
...
- **斜杠命令**：`/review`、`/help` 等——见 [斜杠命令速查](/12-reference/slash-commands/)
- **快捷键**：不输入文字直接触发 UI 动作
...
- 将常用 `codex exec` 封装为 shell alias——见 [命令与快捷方式](/04-product-guides/cli/commands-and-shortcuts/)
...
[IDE 设置](/04-product-guides/ide/settings/) · [选中代码与打开文件](/04-product-guides/ide/selected-code-and-open-files/)
