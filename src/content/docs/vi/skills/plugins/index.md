...
- [Plugins overview](/vi/skills/plugins/plugins-overview/): components, support boundaries, installation verification, and security review
- [Capability map](/vi/skills/capability-map/): compare Plugins, Skills, MCP, Hooks, and Scheduled tasks
...
**Áp dụng cho:** ChatGPT Web / desktop App / Mobile; Codex desktop and CLI; Plugins are not supported in the IDE integration
