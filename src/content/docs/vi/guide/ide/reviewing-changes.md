...
For line comments, staging, or hunk-level reverts, use [Diffs, comments, and review](/vi/guide/desktop-app/diffs-comments-and-review/). For the general method, see [Review diffs](/vi/guide/quality/review-diffs/).
