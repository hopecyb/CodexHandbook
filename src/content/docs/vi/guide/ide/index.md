...
| Chủ đề | Trang |
|---|---|
| Chọn loại | [Trình soạn thảo được hỗ trợ](/guide/ide/supported-editors/) |
| Cài đặt | [Cài đặt](/guide/ide/installation/) |
| Ngữ cảnh | [Ngữ cảnh trình soạn thảo](/guide/ide/editor-context/) · [Vùng chọn và tệp mở](/guide/ide/selected-code-and-open-files/) |
| Quy trình | [Tác vụ local](/guide/ide/local-task-workflow/) · [Tác vụ Cloud](/guide/ide/cloud-task-workflow/) |
| Chất lượng | [Rà soát thay đổi](/guide/ide/reviewing-changes/) |
| Cấu hình | [Cài đặt](/guide/ide/settings/) |
| Xử lý sự cố | [Xử lý sự cố](/guide/ide/troubleshooting/) |

Lối tắt bắt đầu: [Cài đặt tiện ích IDE](/guide/getting-started/install-ide-extension/) · [Chọn client](/guide/getting-started/choose-your-codex-client/)
