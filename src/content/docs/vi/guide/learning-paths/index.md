...
- [Người sáng tạo](/guide/learning-paths/creator/)
...
- Chưa chạy thông Tác vụ đầy đủ lần đầu: đi [Lộ trình người mới](/guide/learning-paths/beginner/)
- Chủ yếu muốn viết nội dung, làm đồ họa chữ, làm demo: xem [Lộ trình người sáng tạo](/guide/learning-paths/creator/)
- Chủ yếu muốn sửa code, sửa bug, nhận dự án: xem [Lộ trình nhà phát triển](/guide/learning-paths/developer/)
- Chủ yếu nghĩ đội triển khai thế nào, kiểm soát rủi ro thế nào: xem [Lộ trình đội](/guide/learning-paths/team/)
