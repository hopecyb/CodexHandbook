...
1. [codex exec](/vi/guide/developer-platform/non-interactive/codex-exec/)
2. [Script và pipeline](/vi/guide/developer-platform/non-interactive/scripts-and-pipelines/)
3. [Đầu ra có cấu trúc](/vi/guide/developer-platform/non-interactive/structured-output/)
4. [Mã thoát và thử lại](/vi/guide/developer-platform/non-interactive/exit-codes-and-retries/)
