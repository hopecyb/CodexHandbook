...
Đ: App máy tính. Xem [Chọn client](/vi/guide/getting-started/choose-your-codex-client/).

**H: Có thể bỏ kiểm tra và chấp nhận mọi thay đổi một lúc không?**  
Đ: Tốt nhất không. Xem [Kiểm chứng và review của người](/vi/guide/foundations/verification-and-human-review/).

**H: Prompt có mẫu chuẩn không?**  
Đ: Có khung, không có phép màu. Xem [Cấu trúc Tác vụ tốt](/vi/prompts/task-anatomy/).
...
Đ: Xem [Bản đồ năng lực mở rộng](/vi/skills/capability-map/) và [Cách chọn phương thức mở rộng](/vi/skills/choosing-an-extension-method/).

**H: Có quy trình chuẩn khuyến nghị không?**  
Đ: Mặc định dùng [Khám phá—Lập kế hoạch—Thực thi—Kiểm chứng](/vi/cases/workflows/explore-plan-execute-verify/).

**H: Cloud nối GitHub, mở PR thế nào?**  
Đ: Xem [Kết nối GitHub](/vi/guide/web-and-cloud/connect-github/) và [Tạo Pull Request](/vi/guide/web-and-cloud/create-pull-requests/).

**H: CLI đưa vào CI được không?**  
Đ: Được; bắt đầu từ [chế độ không tương tác](/vi/guide/cli/non-interactive-mode/), và thiết kế phê duyệt cùng quyền.

**H: Có những lệnh gạch chéo nào?**  
Đ: Lấy theo autocomplete `/` của client; giải thích hướng học xem [Tra cứu lệnh gạch chéo](/vi/guide/reference/slash-commands/).

**H: Lộ trình đầy đủ người sáng tạo/nhà phát triển/đội đâu?**  
Đ: Lộ trình nhập môn đã viết; case sâu xem [Case tình huống](/vi/cases/use-cases/), quản trị đội xem lộ trình M6 `11-team-enterprise`.
