...
- [Thuật ngữ](/vi/guide/reference/glossary/)
- [Câu hỏi thường gặp](/vi/guide/reference/faq/)
- [Đối chiếu tính năng](/vi/guide/reference/feature-comparison/)
- [Tra cứu lệnh gạch chéo](/vi/guide/reference/slash-commands/)

## Tra cứu kỹ thuật

- [Tham chiếu lệnh CLI](/vi/guide/reference/commands/)
- [Tham chiếu cấu hình](/vi/guide/reference/configuration-reference/)
- [Ma trận quyền](/vi/guide/reference/permission-matrix/)
- [Biến môi trường](/vi/guide/reference/environment-variables/)
- [Phím tắt bàn phím](/vi/guide/reference/keyboard-shortcuts/)
- [Tham chiếu lỗi và thông báo](/vi/guide/reference/error-reference/)

## Xử lý sự cố và liên kết ngoài

- [Chỉ mục xử lý sự cố](/vi/guide/reference/troubleshooting/)
