...
- Phối hợp thế nào với bước [kiểm chứng nguồn](/vi/guide/quality/validate-sources/)
...
Tác vụ nghiên cứu dài nên tách nhiều vòng; xem [quản lý tác vụ dài](/vi/cases/workflows/long-running-task-management/).
