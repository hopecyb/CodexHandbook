...
Bienvenue dans le Codex Handbook. Ce handbook considère les **débutants en IA** comme lecteurs par défaut : nous ne supposons pas que vous connaissiez le terminal, Git ou les Agents, mais nous construirons des compétences professionnelles étape par étape.

## Ce que vous obtiendrez

- Clarifier ce que Codex peut et ne peut pas faire
- Choisir un parcours de lecture selon votre rôle et votre Tâche
- Réaliser votre première Tâche vérifiable dans un projet d'entraînement sécurisé
- Apprendre à rédiger des Prompts avec objectifs, contraintes et critères d'acceptation — et à prendre l'habitude de la revue
