...
| Sujet | Page |
|---|---|
| Code et texte | [Fichiers texte et code](/guide/files-and-artifacts/text-and-code-files/) |
| Captures et entrée design | [Images et captures d'écran](/guide/files-and-artifacts/images-and-screenshots/) |
| PDF et longs documents | [PDF et documents](/guide/files-and-artifacts/pdf-and-documents/) |
| Données tabulaires | [Tableaux et tableurs](/guide/files-and-artifacts/tables-and-spreadsheets/) |
| Slides | [Présentations](/guide/files-and-artifacts/presentations/) |
| Sorties Agent | [Artefacts générés](/guide/files-and-artifacts/generated-artifacts/) |

Méthode générale : [Vérifier les artefacts](/guide/quality/verify-artifacts/).
...
4. **Vérification humaine** : généré ≠ terminé ; voir [Définition de terminé](/guide/quality/definition-of-done/)
5. **Données sensibles** : voir [Contexte sensible](/guide/context/sensitive-context/)
...
- Voir images : [Prompt avec images](/prompts/prompting-with-images/)
- Voir pages : [Outil navigateur](/guide/tools/browser/)
- Générer images : [Génération d'images](/guide/tools/image-generation/)
