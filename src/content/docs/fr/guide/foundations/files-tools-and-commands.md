---
title: Fichiers, outils et commands
...
Codex agit sur le monde réel via des **outils** :

- Lire/écrire les fichiers du projet
- Exécuter des commands terminal (quand Permissions et politique de Bac à sable le permettent)
- Rechercher sur le web, ouvrir un navigateur, etc. (selon capacités produit et politique)
