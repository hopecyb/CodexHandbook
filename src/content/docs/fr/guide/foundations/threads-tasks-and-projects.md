...
La formulation produit peut varier légèrement ; ce handbook utilise :

- **Projet / espace de travail** : le dossier ou la racine de dépôt auquel Codex est lié
- **Fil / session** : une conversation continue ; le Contexte s'accumule
- **Tâche** : travail orienté objectif (peut inclure de nombreux appels d'outils)
