---
title: Priorité du Contexte
description: Qui l'emporte quand les instructions entrent en conflit.
locale: fr
source_locale: zh-CN
...
2. Les interdictions de sécurité au niveau projet (ex. « pas de push », « pas de secrets de production ») doivent toujours être respectées
