...
description: Ce que la compaction conserve et ce qu'elle perd dans les longues conversations.
locale: fr
source_locale: zh-CN
...
Aperçu conceptuel : [Tokens, Contexte et compaction](/guide/foundations/tokens-context-and-compaction/)
