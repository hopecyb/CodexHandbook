...
- [ ] J'utilise un répertoire d'entraînement jetable, pas un dépôt de production
- [ ] Le répertoire ne contient pas de vraies clés, mots de passe ou données privées clients
