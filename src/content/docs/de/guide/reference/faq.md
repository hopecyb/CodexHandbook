...
Bei losen Einzelfragen zuerst FAQ. Kein vollständiges System — hilft schnell zu finden, wohin als Nächstes.

## Wann hierhin

- Viele Seiten, unklar was als Nächstes
- Ein Problem blockiert, lohnt aber kein ganzes Kapitel
...
Für Einsteiger oft der schnellste Start.

### 2. FAQ-Antwort reicht zum direkten Handeln?

FAQ macht vor allem:

- Richtungsurteil
- Weiterleitung zur volleren Seite

### 3. Frage fehlt = Handbuch schweigt?
...
Wenn blockiert und unklar wohin:

1. FAQ durchsuchen
2. Nächste Frage finden
3. Link zur Fachseite folgen

Meist sparsamer als Seitenleisten-Herumklicken.

---

**Status:** verified  
**Anwendbare Produkte:** App / CLI / IDE / Cloud  
**Prüfgrundlage:** Gegen geprüfte Einstiege zu Clientwahl, Workflows, Erweiterungen, Cloud-GitHub und Slash-Befehlen abgeglichen; nur FAQ-Navigation, keine volatilen Produktdefaults.  
