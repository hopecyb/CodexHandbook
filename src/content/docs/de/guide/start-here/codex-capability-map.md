...
description: Overview of prompting, tools, extensions, multi-Agent workflows, and governance.
locale: de
source_locale: en
source_revision: '3297e91'
...
```text
Goals and prompts
  → Context (project / files / conversation)
    → Tools (files, terminal, search, browser…)
      → Agent work (plan, execute, steer, hand off)
        → Quality verification and human approval
          → Extensions and automation (Skills / MCP / Hooks…, advanced)
            → Team governance (later milestones)
```

## Modules and authoritative chapters
