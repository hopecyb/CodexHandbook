...
模板说明：[案例模板](/cases/use-cases/case-study-template/)
...
- 用 [探索—计划—执行—验证](/cases/workflows/explore-plan-execute-verify/)
...
**状态：** verified  
**适用产品：** CLI / IDE  
**核验依据：** 已按本手册当前已核验的内容产物、EPXV、构建验收与案例模板章节交叉复核；本页内容限定为“多文件文档站小步修改、构建验证与失败恢复”的稳定内容工程案例。  
**最近核验：** 2026-07-26
