...
多 Agent 适合处理可并行、低耦合的子问题，不适合在没人协调的情况下同时改同一文件。
...
**状态：** verified  
**适用产品：** App / Cloud  
**核验依据：** 已按 OpenAI Developers 当前关于 multi-agent / subagents 的公开说明，以及本手册已核验的子 Agent、交接恢复与并行工作相关章节交叉复核；页面内容限定为“何时拆分、如何隔离边界、如何人工汇总验收”的稳定方法，不把当前 beta 或 UI 入口写成固定契约。  
**最近核验：** 2026-07-26
