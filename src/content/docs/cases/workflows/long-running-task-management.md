...
相关：[委托与跟进](/guide/web-and-cloud/delegate-and-follow-up/) · [Automations](/skills/automations/scheduled-tasks/)
...
[规划](/guide/agent-work/planning/) · [子 Agent](/guide/agent-work/subagents/)
...
- 上下文满时用 [压缩](/guide/context/compaction/) 或新开会话 + 链接进度文件
...
**核验依据：** 已按 OpenAI Developers 当前关于长期目标与长任务协作的公开 use cases，以及本手册已核验的交接恢复、规划、压缩与委托章节交叉复核；本页仅说明长任务的检查点、移交与退出条件等稳定方法。  
**最近核验：** 2026-07-26
