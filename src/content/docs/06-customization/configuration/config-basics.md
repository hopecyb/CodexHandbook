...
概念背景：[模型与推理](/01-foundations/models-and-reasoning/)
...
概念背景：[权限与审批](/01-foundations/permissions-and-approvals/)、[沙盒与网络](/01-foundations/sandbox-and-network/)
...
- 交互式用法：[CLI 交互模式](/04-product-guides/cli/interactive-mode/)
- 非交互与脚本：[非交互模式](/04-product-guides/cli/non-interactive-mode/)
- 配置细节扩展：[CLI 配置](/04-product-guides/cli/configuration/) · [配置项参考](/12-reference/configuration-reference/)
