...
**命令规则**聚焦「Agent 能跑哪些命令、以什么参数跑」。它们是 [允许与拒绝规则](/06-customization/rules/allow-and-deny-patterns/) 的最常见形态，通常写在团队可审查的配置或规则文件中。
...
| 对齐 | 本地规则与 [GitHub Action](/08-developer-platform/ci-cd/code-review-automation/) 尽量同源 |
...
- [允许与拒绝模式](/06-customization/rules/allow-and-deny-patterns/)
- [团队规则策略](/06-customization/rules/team-rules/)
- [CLI 审批与沙盒](/04-product-guides/cli/approvals-and-sandbox/)
- [权限矩阵](/12-reference/permission-matrix/)
