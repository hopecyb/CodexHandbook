...
| 新指南页 | `src/content/docs/` 下章节正文 | [撰写指南](/13-contributing/write-a-guide/) |
| 案例 | `10-use-cases/` | [案例模板](/10-use-cases/case-study-template/) |
| 提示词实例 | `examples/prompts/` | [添加提示词示例](/13-contributing/add-a-prompt-example/) |
| 技术核验 | 标 `verified`、更新日期 | [核验技术内容](/13-contributing/verify-technical-content/) |
