...
See [Supported editors](/es/guide/ide/supported-editors/) for the complete matrix.
...
For the longer beginner path, see [Install an IDE integration](/es/guide/getting-started/install-ide-extension/).
