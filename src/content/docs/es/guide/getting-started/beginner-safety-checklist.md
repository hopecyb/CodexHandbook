---
title: Beginner safety checklist
description: Safety checks to review before your first use.
locale: es
source_locale: en
source_revision: 69e2c30
...
- [ ] I'm using a disposable practice directory, not a production repo
- [ ] The directory has no real keys, passwords, or customer private data
