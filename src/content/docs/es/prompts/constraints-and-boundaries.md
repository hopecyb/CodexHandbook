...
Escribe los límites de permiso junto con las restricciones para reducir extralimitaciones «de paso». Ver [Definir el terminado](/es/prompts/define-done/) y [Permisos y sandbox](/es/guide/permissions-and-sandbox/).
