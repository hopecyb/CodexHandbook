...
CLI configuration sets **default model, working directory, approval strictness, MCP servers**, and more. Same concepts as [Configuration basics](/06-customization/configuration/config-basics/); this page focuses on what terminal users change often.
...
Concepts: [Sandbox and network](/01-foundations/sandbox-and-network/)
...
Shared with [Connect an MCP server](/07-extensions-automation/mcp/connect-an-mcp-server/); restart sessions after changes.
...
More: [CLI troubleshooting](/04-product-guides/cli/troubleshooting/)
