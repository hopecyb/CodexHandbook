...
- Relationship to [CLI configuration](/04-product-guides/cli/configuration/)
...
See [Human approval patterns](/09-workflows/human-approval-patterns/).
...
Interactive usage: [CLI interactive mode](/04-product-guides/cli/interactive-mode/)
