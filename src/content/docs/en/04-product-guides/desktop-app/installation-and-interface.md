...
For installation steps, see [Install the desktop App](/02-getting-started/install-desktop-app/) and [https://developers.openai.com/codex](https://developers.openai.com/codex).
