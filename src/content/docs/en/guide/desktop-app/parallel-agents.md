---
title: Parallel chats and Agents
description: Use independent chats and worktrees to advance tasks that can be accepted separately.
locale: en
source_locale: zh-CN
...
![Orchestration diagram in which the main thread delegates independent work to several subagents and consolidates evidence and conflicts](/diagrams/subagent-orchestration-en.svg)
...
Put each coding chat in a separate [worktree](/en/guide/desktop-app/worktrees/). Assign shared configuration to the main chat or one designated owner.
...
For finer-grained tool orchestration, see [Subagents](/en/guide/agent-work/subagents/).
