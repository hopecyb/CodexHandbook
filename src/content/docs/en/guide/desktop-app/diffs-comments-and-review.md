---
title: Diffs, comments, and review
description: Verify the actual changes and leave line-level feedback in the review pane before committing or pushing.
locale: en
source_locale: zh-CN
...
Use a consistent acceptance order: scope → behavior → tests → security → maintainability. See [Review diffs](/en/guide/quality/review-diffs/) for more techniques.
