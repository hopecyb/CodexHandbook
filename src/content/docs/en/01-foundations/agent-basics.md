...
- Skill / Plugin / MCP: extend **what it can do** and **what it connects to**—advanced chapters to follow; see the [capability map](/00-start-here/codex-capability-map/) for how they differ
- Human approval: see [Permissions and approvals](/01-foundations/permissions-and-approvals/)
