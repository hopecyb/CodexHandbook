...
Beginners should default to **local + desktop App**. Cloud details: [Web and Cloud overview](/04-product-guides/web-and-cloud/). Switching in the App: [Local and cloud tasks](/04-product-guides/desktop-app/local-and-cloud-tasks/).
