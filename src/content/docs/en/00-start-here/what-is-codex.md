...
See the [feature comparison](/12-reference/feature-comparison/) for a side-by-side table. For how concepts relate, see the [capability map](/00-start-here/codex-capability-map/).
