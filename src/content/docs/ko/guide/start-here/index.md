---
title: 여기서부터 시작
description: Codex가 무엇인지, 누구에게 맞는지 이해하고 학습 경로를 고릅니다.
sidebar:
  order: 1
locale: ko
source_locale: zh-CN
...
이 핸드북은 주로 **AI 초보자**를 대상으로 합니다. 터미널·Git·Agent를 이미 안다고 가정하지 않지만, 앞으로 만나게 될 역량은 단계적으로 풀어 설명합니다.

## 내용

- Codex가 할 수 있는 일과 할 수 없는 일을 정리합니다
- 역할과 작업에 맞춰 읽는 경로를 고릅니다
- 안전한 연습 프로젝트에서 확인 가능한 첫 작업을 마칩니다
- 「목표·제약·수락 기준」으로 프롬프트를 쓰고 검토 습관을 들입니다
...
### 1. 「여기서부터 시작」이 모든 내용을 한 번에 다 알려 주지는 않습니다

이 장은 입구와 순서를 분명히 하는 데 초점이 있으며, 모든 내용을 한 번에 밀어 넣지 않습니다.

### 2. 처음에는 모르는 단어가 많아도 계속 읽어도 됩니다
...
### 3. 개념만 이해해서는 바로 쓰기 어렵습니다

그것만으로는 부족합니다. 이해·작은 범위의 실습·결과 확인을 함께 해야 합니다.
...
이 장은 시작 단계의 순서와 경계를 설명하며, 눈에 띄는 위험도 미리 짚어 둡니다.

---

**상태:** verified  
**적용 제품:** App / CLI / IDE / Cloud  
**검증 근거:** 이 페이지는 시작 순서와 읽기 입구만 설명합니다. 사이트 내 링크·장 계층·안내 구조를 재확인했으며, 본문은 쉽게 변하는 제품 사실에 의존하지 않습니다.  
**최근 검증:** 2026-07-26
