...
| 도구 | 페이지 |
|---|---|
| 선택 개요 | [도구 선택](/ko/guide/tools/tool-selection/) |
| 터미널 | [Shell과 터미널](/ko/guide/tools/shell-and-terminal/) |
| 검색 | [Web 검색](/ko/guide/tools/web-search/) |
| 웹페이지 | [브라우저 도구](/ko/guide/tools/browser/) |
| GUI | [Computer Use](/ko/guide/tools/computer-use/) |
| 이미지 | [이미지 생성](/ko/guide/tools/image-generation/) |
| 음성 | [음성 입력과 출력](/ko/guide/tools/voice/) |

파일 읽기/쓰기와 산출물 검증은 [파일과 산출물](/ko/guide/files-and-artifacts/)을 보세요. 확장 도구는 [MCP](/ko/skills/mcp/mcp-overview/)로 연결합니다.

## 권장 읽는 순서

이 장을 처음 볼 때:

1. [도구 선택](/ko/guide/tools/tool-selection/)으로 작업별 우선 도구를 봄
2. [Shell과 터미널](/ko/guide/tools/shell-and-terminal/)로 명령 실행 위험을 봄
