...
다음 상황이면 FAQ를 먼저 뒤지세요.

- 페이지가 많아 다음에 어디를 볼지 모름
- 어떤 질문에 막혔지만 전체 장을 펼칠 정도는 아님
- 방향 판단만 먼저 얻고 싶음
...
### 1. FAQ는 봐도 되고 안 봐도 되나?

초보자에게는 비교적 빠른 시작점이 되는 경우가 많습니다.

### 2. FAQ의 답만으로 바로 조작해도 되나?
...
### 3. 여기 없는 질문이면 핸드북에 안 나온 건가?

가끔은 그 질문이 이미 다음으로 흩어져 있습니다.
...
막혔는데 어느 페이지로 가야 할지 모르겠다면, 이렇게 쓰세요.

1. FAQ를 먼저 뒤짐
2. 가장 가까운 질문을 찾음
3. 링크를 따라 대응 특집으로 들어감

사이드바를 왔다 갔다 하는 것보다 보통 수월합니다.

---

**상태：** verified  
**적용 제품：** App / CLI / IDE / Cloud  
**검증 근거：** 본 핸드북에서 검증된 클라이언트 선택, 워크플로, 확장 방식, Cloud GitHub 흐름, 슬래시 명령 관련 입구를 항목별로 교차 확인했습니다. 이 페이지는 고빈도 질문 내비일 뿐이며, 변동하기 쉬운 제품 기본값을 단독으로 단정하지 않습니다.  
**최근 검증：** 2026-07-26
