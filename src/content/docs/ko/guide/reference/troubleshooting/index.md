...
증상으로 방향을 찾는 편이, 사이트 전체를 왔다 갔다 하는 것보다 빠릅니다.
...
문제 종류를 잠깐 말하기 어렵다면, 아래처럼 나눠 보세요.

1. “들어가지 못하나?”
2. “돌아가지 않나?”
3. “돌았는데 결과가 틀리나?”
4. “도구나 입구를 어떻게 고를지 모르나?”

보통 대응 페이지로 더 빨리 떨어집니다.

공식 지원과 문서：[https://developers.openai.com/codex](https://developers.openai.com/codex)

---

**상태：** verified  
**적용 제품：** App / CLI / IDE / Cloud  
**검증 근거：** 본 저장소의 현재 장애 분석 입구, 로그인/클라이언트 선택, 결과 확인, 컨텍스트·권한 관련 장을 교차 확인했습니다. 이 페이지는 “증상으로 다음 페이지를 가리키는” 색인 역할만 담당하며, 구체 오류나 제품 동작을 장기 계약으로 쓰지 않습니다.  
**최근 검증：** 2026-07-26
