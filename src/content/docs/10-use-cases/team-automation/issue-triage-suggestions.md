...
**执行：** `codex exec` 传入 issue title + body（注意 [prompt 注入](/11-team-enterprise/security/prompt-injection/) 消毒）。
...
- 与 [Webhook](/08-developer-platform/webhooks/overview/) 对接内部工单系统（可选）
- 复盘写入 [案例模板](/10-use-cases/case-study-template/)
