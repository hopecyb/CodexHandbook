...
- 启用 [网页搜索](/05-core-capabilities/tools/web-search/)（若产品支持）

## 3. 工作流

遵循 [带引用的研究](/09-workflows/research-with-sources/)：
...
**验证：** 人工点开 3 个 URL；检查日期与 [核验政策](/00-start-here/handbook-version-policy/)。
...
- [产物优先](/09-workflows/artifact-first-work/)
