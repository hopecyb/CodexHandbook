...
已能跑通 [首个任务](/02-getting-started/run-your-first-task/)，并愿意在测试仓库里试验。
...
- [ ] 已对照 [权限与审批](/01-foundations/permissions-and-approvals/) 检查脚本需求（本示例无脚本）

## 下一步

- 把 [探索—计划—执行—验证](/09-workflows/explore-plan-execute-verify/) 固化成 Skill
- 需要接 GitHub API 时，再引入 [MCP](/07-extensions-automation/mcp/mcp-overview/)
