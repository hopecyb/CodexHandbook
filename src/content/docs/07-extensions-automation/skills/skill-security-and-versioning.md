...
基础：[Skill 概述](/07-extensions-automation/skills/skills-overview/) · [创建第一个 Skill](/07-extensions-automation/skills/create-your-first-skill/)
...
Plugin 可把 Skill 打包统一分发：[Plugins 概述](/07-extensions-automation/plugins/plugins-overview/)
...
- [ ] 季度复查仍需要的 Skill
- [ ] 与 [允许与拒绝规则](/06-customization/rules/allow-and-deny-patterns/) 一致
