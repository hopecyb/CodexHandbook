...
入门：[MCP 概述](/07-extensions-automation/mcp/mcp-overview/) · [连接 MCP 服务器](/07-extensions-automation/mcp/connect-an-mcp-server/)
...
环境变量索引：[环境变量](/12-reference/environment-variables/)
...
错误索引：[错误与提示参考](/12-reference/error-reference/)
