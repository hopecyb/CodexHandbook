...
拆成多段 Automation + [交接与恢复](/05-core-capabilities/agent-work/handoff-and-resume/)，避免单次上下文耗尽。

## 与 Cloud / CLI 的关系

- **Cloud**：适合与 GitHub 深度集成的远程自动化
- **CLI + cron/CI**：适合内网、自定义流水线
- 选型见 [本地与云端](/01-foundations/local-vs-cloud/) 与 [Web 与 Cloud](/04-product-guides/web-and-cloud/)
