...
敏感上下文总则：[敏感上下文](/05-core-capabilities/context/sensitive-context/)
...
与 [GitHub 集成](/04-product-guides/integrations/github/) 配合时，优先使用平台原生 Secrets，而非让 Agent 从 issue 正文复制密钥。
