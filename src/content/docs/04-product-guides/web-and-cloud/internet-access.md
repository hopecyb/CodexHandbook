...
本页侧重 **Cloud 环境**；通用概念见 [沙盒与网络](/01-foundations/sandbox-and-network/)。

## 典型需要出网的场景

- 安装依赖：`npm install`、`pip install`、`go mod download`
- 拉取私有 registry（需 [Secrets](/04-product-guides/web-and-cloud/secrets-and-variables/)）
...
1. 在 [Cloud 环境](/04-product-guides/web-and-cloud/cloud-environments/) 中确认当前网络策略
