...
与 [连接 GitHub](/04-product-guides/web-and-cloud/connect-github/) 配合使用；环境**不能**访问你笔记本上未推送的 commit。
...
| 工作目录 | 克隆后的仓库路径 |
| 网络策略 | 是否允许出网、访问哪些域名 |
| 凭据注入 | [Secrets 与变量](/04-product-guides/web-and-cloud/secrets-and-variables/) |
...
3. 配置 [Secrets](/04-product-guides/web-and-cloud/secrets-and-variables/)（私有 registry、API key）
4. 确认 [互联网访问](/04-product-guides/web-and-cloud/internet-access/) 策略符合安全要求
...
长任务可在 [桌面 App 通知](/04-product-guides/desktop-app/notifications/) 或移动端跟进。
